...
class VuelosControllerTest < ActionController::TestCase
  ...
  test "should create vuelo" do
    assert_difference('Vuelo.count') do
      post :create, vuelo: { aerolinea_id: @vuelo.aerolinea_id, capacidad: @vuelo.capacidad, itinerario_id: @vuelo.itinerario_id, modelo_avion: @vuelo.modelo_avion, num_vuelo: @vuelo.num_vuelo }
    end
  ...
  test "should update vuelo" do
    patch :update, id: @vuelo, vuelo: { aerolinea_id: @vuelo.aerolinea_id, capacidad: @vuelo.capacidad, itinerario_id: @vuelo.itinerario_id, modelo_avion: @vuelo.modelo_avion, num_vuelo: @vuelo.num_vuelo }
    assert_redirected_to vuelo_path(assigns(:vuelo))
  end
